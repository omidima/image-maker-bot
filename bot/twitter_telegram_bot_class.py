...
from bot.actions.twitter.twitter_view import add_instagram_account_view, check_hashtag_view, start, add_state_to_context, add_type_to_context
from bot.actions.twitter.twitter_action import handle_command
from bot.utils import ACTION_KEY


class TelegramBot:
    def __init__(self) -> None:
        self.updater = Updater(token="6792325932:AAGuKpbNDSWGv6lsf0uBDxGW4unAWZ2Wp6Q", use_context=True)
